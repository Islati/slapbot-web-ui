        ...
        <v-card class="mx-auto pa-1" variant="elevated">
                ...
                <v-col cols="12">
                    <v-row>
                        ...
                        <v-col offset="0.5" cols="2" class="mt-2">
                            <v-row>
                                <v-col cols="6">
                                    <v-badge :color="messageBadgeColor" :content="messageCount" @click="() => $router.push({'path':`/users/${this.user.id}`})">
                                ...
                                <v-col cols="6">
                                    ...
                                    <v-badge :color="commentBadgeColor" :content="commentCount" @click="() => $router.push({'path':`/users/${this.user.id}`})">
            ...
            <v-row>
                <v-col cols="12">
                    ...
                    <v-chip class="ml-2" color="white" label>
                        <NuxtLink :to="localProfileUrl">
                            Show More
